...
walk (StepL:stx) (Node _v l _r) = walk stx l
walk (StepR:stx) (Node _v _l r) = walk stx r
...
set (StepL:stx) val (Node v l r) = Node v (set stx val l) r
set (StepR:stx) val (Node v l r) = Node v l (set stx val r)
